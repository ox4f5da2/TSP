...
3. 会提示用户是否显示城市网络图，其中输入Y/y表示显示，N/n表示不显示。该图包括了最初的旅行商城市分布图（随机生成的城市坐标）以及最优路径解的网络图，示例如下：<img src="./src/images/img1.png" alt="路径网络图" style="max-width: 60%;" />
...
<img src="./src/images/img4.png" alt="自动化测试功能的运行结果图" style="max-width: 80%;" />
